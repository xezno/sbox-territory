...
public partial class PlayerAnimator : EntityComponent<Player>, ISingletonComponent
{
	public virtual void Simulate( IClient cl )
	{
		...
		float mappedCameraHeight = 1 - controller.CurrentEyeHeight.Remap( 30, 72, 0, 1 ).Clamp( 0, 1 );
		animHelper.DuckLevel = animHelper.DuckLevel.LerpTo( mappedCameraHeight, Time.Delta * 10.0f );
